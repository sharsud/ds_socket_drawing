...
const CONFIG = {
    ...
    PACKET_DELAY: 15,           // Faster packet delivery
    TIME_LIMIT_MS: 48000,
    WHITE_THRESHOLD: 240,       // Better white skipping for clean backgrounds
    COLOR_LIMIT: 32,
    RES_WIDTH: 450,
    STRICT_UP_DIST: 0.02,
    SEARCH_LOOKAHEAD: 140,
    LAYERS: [
        { thick: 6, step: 3, maxPoints: 60 } // Thicker brush = fewer strokes = faster fill
    ],
    CANVAS_WIDTH: 800,
    CANVAS_HEIGHT: 600,
    WATCH_DIR: './images'
